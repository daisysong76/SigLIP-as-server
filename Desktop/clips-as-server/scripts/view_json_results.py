#!/usr/bin/env python3
"""
View LLaVA reasoning results from JSON file.
Simple tool to visualize and verify LLaVA outputs from the JSON metadata file.
"""
import json
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description="View LLaVA results from JSON file")
